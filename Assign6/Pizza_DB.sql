...
(
cust_id varchar2(4) constraint cust_pk PRIMARY KEY,
...
create table pizza
(
pizza_id varchar2(4) constraint pizza_pk PRIMARY KEY,
...
create table orders
(
order_no varchar2(5) constraint order_pk PRIMARY KEY,
cust_id varchar2(4) constraint cust_fk references customer(cust_id),
order_date date,
delv_date date,
total_amt number,
discount number,
...
(
order_no varchar2(5) constraint order_fk references orders(order_no), 
pizza_id varchar2(4) constraint pizza_fk references pizza(pizza_id), 
qty number,
constraint pk PRIMARY KEY(order_no,pizza_id)
);
...
insert into orders(order_no, cust_id, order_date ,delv_date) values('OP100','c001','28-JUN-2015','30-JUN-2015');
insert into orders(order_no, cust_id, order_date ,delv_date) values('OP200','c002','28-JUN-2015','30-JUN-2015');
insert into orders(order_no, cust_id, order_date ,delv_date) values('OP300','c003','29-JUN-2015','01-JUL-2015');
insert into orders(order_no, cust_id, order_date ,delv_date) values('OP400','c004','29-JUN-2015','01-JUL-2015');
insert into orders(order_no, cust_id, order_date ,delv_date) values('OP500','c001','29-JUN-2015','01-JUL-2015');
insert into orders(order_no, cust_id, order_date ,delv_date) values('OP600','c002','29-JUN-2015','01-JUL-2015');
