...
(
	...
	CONSTRAINT song_len_check_7 CHECK((Song_len >= 7 AND Song_genre='PAT' ) OR (Song_genre in ('PHI','REL','LOV','DEV')))  
);
...
(
	...
	track NUMBER(3) ,
	recording_date DATE,
	CONSTRAINT al_id__track_fk FOREIGN KEY (al_ID,track) REFERENCES Song(alb_ID,track_no) ,
